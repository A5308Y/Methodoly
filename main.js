...
var _user$project$ProgrissStore$Store = F4(
	function (a, b, c, d) {
		return {projects: a, actions: b, contexts: c, notes: d};
	});
...
var _user$project$ProgrissStore$castActionDataToAction = function (_p41) {
	var _p42 = _p41;
	var _p43 = _p42._1;
	return A3(
		_user$project$ProgrissStore$Action,
		_user$project$ProgrissStore$ActionId(_p42._0),
		_p43.description,
		_p43.state);
};
...
var _user$project$ProgrissStore$checkOffAction = F2(
	function (_p63, _p62) {
		var _p64 = _p63;
		var _p65 = _p62;
		var _p66 = _p65._0;
			...
			_elm_lang$core$Maybe$map(
				function (actionData) {
					return _elm_lang$core$Native_Utils.update(
						actionData,
						{
							state: _user$project$ProgrissStore$Done(0)
						});
				}),
			_p66.actions);
		return _user$project$ProgrissStore$ProgrissStore(
...
var _user$project$ProgrissStore$createAction = F2(
	function (description, _p67) {
		var _p68 = _p67;
		var _p69 = _p68._0;
		var updatedActions = A3(
			_elm_lang$core$Dict$insert,
			_user$project$ProgrissStore$getNextFreeId(_p69.actions),
		...
		var state = function () {
			...
			if (_p70.ctor === 'Nothing') {
				...
				if (_p71.ctor === 'Nothing') {
					...
					return _user$project$ProgrissStore$Done(_p71._0);
				}
			} else {
				return _user$project$ProgrissStore$Deleted(_p70._0);
			}
		}();
		return {
			ctor: '_Tuple2',
...
var _user$project$ProgrissStore$castContextDataToContext = function (_p72) {
	var _p73 = _p72;
	return A2(
		_user$project$ProgrissStore$Context,
		_user$project$ProgrissStore$ContextId(_p73._0),
		_p73._1.name);
};
			...
			A2(
				...
				function (contextId) {
					return A2(
						...
						A2(_elm_lang$core$Dict$get, contextId, _p78.contexts));
				},
				A2(
					_elm_lang$core$Maybe$andThen,
					function (action) {
					...
					A2(_elm_lang$core$Dict$get, _p76._0, _p78.actions))));
	});
var _user$project$ProgrissStore$getAllContexts = function (_p79) {
	var _p80 = _p79;
	return A2(
		_elm_lang$core$List$map,
		_user$project$ProgrissStore$castContextDataToContext,
		_elm_lang$core$Dict$toList(_p80._0.contexts));
};
var _user$project$ProgrissStore$ProjectId = function (a) {
	return {ctor: 'ProjectId', _0: a};
};
var _user$project$ProgrissStore$castProjectDataToProject = function (_p81) {
	var _p82 = _p81;
	return A2(
		_user$project$ProgrissStore$Project,
		_user$project$ProgrissStore$ProjectId(_p82._0),
		_p82._1.title);
};
			...
			A2(
				...
				function (projectId) {
					return A2(
						...
						A2(_elm_lang$core$Dict$get, projectId, _p87.projects));
				},
				A2(
					_elm_lang$core$Maybe$andThen,
					function (action) {
					...
					A2(_elm_lang$core$Dict$get, _p85._0, _p87.actions))));
	});
var _user$project$ProgrissStore$getAllProjects = function (_p88) {
	var _p89 = _p88;
	return A2(
		_elm_lang$core$List$map,
		_user$project$ProgrissStore$castProjectDataToProject,
		_elm_lang$core$Dict$toList(_p89._0.projects));
};
var _user$project$ProgrissStore$NoteId = function (a) {
	return {ctor: 'NoteId', _0: a};
};
var _user$project$ProgrissStore$castNoteDataToNote = function (_p90) {
	var _p91 = _p90;
	return A2(
		_user$project$ProgrissStore$Note,
		_user$project$ProgrissStore$NoteId(_p91._0),
		_p91._1.body);
};
	...
	function (_p93, _p92) {
		...
		return A2(
			...
			A2(
				...
				function (_p96) {
					var _p97 = _p96;
					return _elm_lang$core$Native_Utils.eq(_p97._1.projectId, _p94._0);
				},
				_elm_lang$core$Dict$toList(_p95._0.notes)));
	});
...
var _user$project$Workflows_GtdActionLists$Model = F2(
	function (a, b) {
		return {selectedContext: a, newActionDescription: b};
	});
...
var _user$project$Workflows_GtdActionLists$initialModel = {selectedContext: _user$project$Workflows_GtdActionLists$AnywhereContext, newActionDescription: ''};
var _user$project$Workflows_GtdActionLists$CheckOffAction = function (a) {
	return {ctor: 'CheckOffAction', _0: a};
};
												...
												_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
													{
														...
														_0: _elm_lang$html$Html_Events$onClick(
															_user$project$Workflows_GtdActionLists$CheckOffAction(action.id)),
														_1: {
															ctor: '::',
...
var _user$project$Workflows_ProjectCardOverview$projectsPerRow = 3;
var _user$project$Workflows_ProjectCardOverview$projectCardNoteList = F2(
...
var _user$project$Workflows_ProjectCardOverview$projectCardActionList = F2(
	function (projectId, store) {
		return A2(
			_elm_lang$core$List$map,
			function (action) {
...
var _user$project$Workflows_ProjectCardOverview$projectCard = F2(
		...
		return A3(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A2(_user$project$Workflows_ProjectCardOverview$projectCardNoteList, project.id, store),
						_1: {
							ctor: '::',
							_0: A2(
								_rundis$elm_bootstrap$Bootstrap_Button$button,
			...
			A2(
				...
				A2(_user$project$Workflows_ProjectCardOverview$projectCardActionList, project.id, store),
				A3(
					_rundis$elm_bootstrap$Bootstrap_Card$block,
					{ctor: '[]'},
					{
		...
		return A2(
			...
			A2(
				...
				function (projectGroup) {
					return _rundis$elm_bootstrap$Bootstrap_Card$deck(
						A2(
							_elm_lang$core$List$map,
							_user$project$Workflows_ProjectCardOverview$projectCard(store),
							projectGroup));
				},
				groupedProjects));
	});
var _user$project$Workflows_ProjectCardOverview$update = F3(
	function (msg, store, model) {
		return {ctor: '_Tuple3', _0: model, _1: store, _2: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$Workflows_ProjectCardOverview$initialModel = {};
var _user$project$Workflows_ProjectCardOverview$Model = {};
var _user$project$Workflows_ProjectCardOverview$Never = {ctor: 'Never'};
...
var _user$project$Workflows_SimpleTodos$CheckOffAction = function (a) {
	return {ctor: 'CheckOffAction', _0: a};
};
												...
												_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_user$project$Workflows_SimpleTodos$CheckOffAction(action.id)),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('bmd-btn-fab bmd-btn-fab-sm'),
															_1: {ctor: '[]'}
...
var _user$project$Main$initialModel = {
	ctor: '_Tuple2',
	_0: {store: _user$project$Main$initialStore, gtdActionListsModel: _user$project$Workflows_GtdActionLists$initialModel, projectCardOverviewModel: _user$project$Workflows_ProjectCardOverview$initialModel, simpleTodosModel: _user$project$Workflows_SimpleTodos$initialModel},
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {store: a, gtdActionListsModel: b, projectCardOverviewModel: c, simpleTodosModel: d};
	});
...
var _user$project$Main$ProjectCardOverviewMsg = function (a) {
	return {ctor: 'ProjectCardOverviewMsg', _0: a};
};
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			...
			case 'ProjectCardOverviewMsg':
				var _p4 = A3(_user$project$Workflows_ProjectCardOverview$update, _p1._0, model.store, model.projectCardOverviewModel);
				...
				return {
					...
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$ProjectCardOverviewMsg, cmd)
				};
			default:
...
var _user$project$Main$renderWorkflow = function (model) {
	return (_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$List$length(
			_user$project$ProgrissStore$getAllActions(model.store)),
		10) < 0) ? A2(
		_elm_lang$html$Html$map,
		_user$project$Main$SimpleTodosMsg,
		A2(_user$project$Workflows_SimpleTodos$view, model.store, model.simpleTodosModel)) : A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$map,
						_user$project$Main$ProjectCardOverviewMsg,
						A2(_user$project$Workflows_ProjectCardOverview$view, model.store, model.projectCardOverviewModel)),
					_1: {ctor: '[]'}
				}
			}
		});
