...
var _user$project$ListHelper$groupsOf = F3(
	function (size, elementsLeftToGroup, groupedElements) {
		groupsOf:
		while (true) {
			if (_elm_lang$core$List$isEmpty(elementsLeftToGroup)) {
				return groupedElements;
			} else {
				var _v0 = size,
					_v1 = A2(_elm_lang$core$List$drop, size, elementsLeftToGroup),
					_v2 = {
					ctor: '::',
					_0: A2(_elm_lang$core$List$take, size, elementsLeftToGroup),
					_1: groupedElements
				};
				size = _v0;
				elementsLeftToGroup = _v1;
				groupedElements = _v2;
				continue groupsOf;
			}
		}
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_1: {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'description',
					_1: _elm_lang$core$Json_Encode$string(_p13.description)
				},
				_1: {
					ctor: '::',
					_0: {
...
var _user$project$ProgrissStore$encoder = function (_p14) {
	var _p15 = _p14;
	var _p16 = _p15._0;
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				...
				_1: _elm_lang$core$Json_Encode$list(
					A2(
						...
						_elm_lang$core$Dict$toList(_p16.actions)))
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_1: _elm_lang$core$Json_Encode$list(
						A2(
							...
							_elm_lang$core$Dict$toList(_p16.contexts)))
				},
				_1: {
					ctor: '::',
					_0: {
						...
						_1: _elm_lang$core$Json_Encode$list(
							A2(
								...
								_elm_lang$core$Dict$toList(_p16.projects)))
					},
					_1: {
						ctor: '::',
						_0: {
							...
							_1: _elm_lang$core$Json_Encode$list(
								A2(
									...
									_elm_lang$core$Dict$toList(_p16.notes)))
						},
						_1: {ctor: '[]'}
					}
				}
	...
	return A2(
		...
		A2(
			...
			_elm_lang$core$List$maximum(
				_elm_lang$core$Dict$keys(dictionary))));
};
var _user$project$ProgrissStore$Store = F5(
	function (a, b, c, d, e) {
...
var _user$project$ProgrissStore$ProjectData = function (a) {
	return {title: a};
};
var _user$project$ProgrissStore$projectDataConstructor = F2(
	function (id, title) {
		return {
			ctor: '_Tuple2',
			_0: id,
			_1: _user$project$ProgrissStore$ProjectData(title)
		};
	});
var _user$project$ProgrissStore$projectDecoder = A3(
	...
	A3(
		...
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$ProgrissStore$projectDataConstructor)));
var _user$project$ProgrissStore$ContextData = function (a) {
	return {name: a};
};
var _user$project$ProgrissStore$contextDataConstructor = F2(
	function (id, name) {
		return {
			ctor: '_Tuple2',
			_0: id,
			_1: _user$project$ProgrissStore$ContextData(name)
		};
	});
var _user$project$ProgrissStore$contextDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'name',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		'id',
		_elm_lang$core$Json_Decode$int,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$ProgrissStore$contextDataConstructor)));
var _user$project$ProgrissStore$NoteData = F2(
	function (a, b) {
		return {body: a, projectId: b};
	});
var _user$project$ProgrissStore$noteDataConstructor = F3(
	function (id, content, projectId) {
		return {
			ctor: '_Tuple2',
			_0: id,
			_1: A2(_user$project$ProgrissStore$NoteData, content, projectId)
		};
	});
var _user$project$ProgrissStore$noteDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'project_id',
	_elm_lang$core$Json_Decode$int,
	A3(
		...
		A3(
			...
			'id',
			_elm_lang$core$Json_Decode$int,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$ProgrissStore$noteDataConstructor))));
var _user$project$ProgrissStore$Action = F3(
	function (a, b, c) {
		return {id: a, description: b, state: c};
	});
var _user$project$ProgrissStore$Project = F2(
	function (a, b) {
		return {id: a, title: b};
	});
var _user$project$ProgrissStore$Context = F2(
	function (a, b) {
		return {id: a, name: b};
	});
var _user$project$ProgrissStore$Note = F2(
	function (a, b) {
		return {id: a, body: b};
	});
var _user$project$ProgrissStore$ProgrissStore = function (a) {
...
var _user$project$ProgrissStore$progrissStoreConstructor = F4(
	function (actions, contexts, projects, notes) {
		return _user$project$ProgrissStore$ProgrissStore(
			{
				actions: _elm_lang$core$Dict$fromList(actions),
...
var _user$project$ProgrissStore$Done = function (a) {
...
var _user$project$ProgrissStore$actionDataConstructor = F6(
	function (id, description, maybeContextId, maybeProjectId, finishedAt, deletedAt) {
		...
		return {
			ctor: '_Tuple2',
			_0: id,
			_1: A4(_user$project$ProgrissStore$ActionData, description, maybeContextId, maybeProjectId, state)
		};
	});
var _user$project$ProgrissStore$actionDecoder = A4(
			...
			A4(
				...
				A3(
					...
					A3(
						...
						'id',
						_elm_lang$core$Json_Decode$int,
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$ProgrissStore$actionDataConstructor)))))));
var _user$project$ProgrissStore$decoder = A4(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
	'notes',
	_elm_lang$core$Json_Decode$list(_user$project$ProgrissStore$noteDecoder),
	{ctor: '[]'},
	A4(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
		'projects',
		_elm_lang$core$Json_Decode$list(_user$project$ProgrissStore$projectDecoder),
		{ctor: '[]'},
		A4(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
			'contexts',
			_elm_lang$core$Json_Decode$list(_user$project$ProgrissStore$contextDecoder),
			{ctor: '[]'},
			A4(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
				'actions',
				_elm_lang$core$Json_Decode$list(_user$project$ProgrissStore$actionDecoder),
				{ctor: '[]'},
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$ProgrissStore$progrissStoreConstructor)))));
...
var _user$project$Workflows_GtdActionLists$iconForActionState = function (state) {
	var _p2 = state;
	if (_p2.ctor === 'Done') {
		return 'done';
	} else {
...
var _user$project$Workflows_GtdActionLists$navbarContent = F2(
		...
		return A2(
			_elm_lang$html$Html$button,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Workflows_GtdActionLists$ToggleContextMenu(!model.contextMenuVisible)),
					_1: {ctor: '[]'}
				}
			},
			{
										...
										},
										{
											...
											_0: A2(
												...
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(
														_user$project$Workflows_GtdActionLists$iconForActionState(action.state)),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
...
var _user$project$Workflows_ProjectOverview$projectCardNoteList = F2(
	function (projectId, store) {
		return A2(
			...
			A2(
				...
				A2(_user$project$ProgrissStore$getNotesForProject, projectId, store)));
	});
var _user$project$Workflows_ProjectOverview$projectCardActionList = F2(
	function (projectId, store) {
		return A2(
			_elm_lang$core$List$map,
			function (action) {
			...
			A2(_user$project$ProgrissStore$getActionsForProject, projectId, store));
	});
var _user$project$Workflows_ProjectOverview$projectCard = F2(
		...
		return A3(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A2(_user$project$Workflows_ProjectOverview$projectCardNoteList, project.id, store),
						_1: {
							ctor: '::',
							_0: A2(
								_rundis$elm_bootstrap$Bootstrap_Button$button,
			...
			A2(
				...
				A2(_user$project$Workflows_ProjectOverview$projectCardActionList, project.id, store),
				A3(
					_rundis$elm_bootstrap$Bootstrap_Card$block,
					{ctor: '[]'},
					{
						ctor: '::',
						_0: A2(
							_rundis$elm_bootstrap$Bootstrap_Card_Block$titleH3,
							{ctor: '[]'},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(project.title),
...
var _user$project$Workflows_ProjectOverview$projectCardColumn = F2(
	function (store, projectGroup) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _rundis$elm_bootstrap$Bootstrap_Utilities_Spacing$m4,
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _rundis$elm_bootstrap$Bootstrap_Card$deck(
					A2(
						_elm_lang$core$List$map,
						_user$project$Workflows_ProjectOverview$projectCard(store),
						projectGroup)),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Workflows_ProjectOverview$view = F2(
	function (store, model) {
		...
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$Workflows_ProjectOverview$projectCardColumn(store),
				_elm_lang$core$List$reverse(
					A3(
...
var _user$project$Workflows_ProjectOverview$update = F3(
	function (msg, store, model) {
		return {ctor: '_Tuple3', _0: model, _1: store, _2: _elm_lang$core$Platform_Cmd$none};
	});
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Project Overview'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text('Projects per row: '),
						_1: {
							ctor: '::',
							_0: A2(
								_rundis$elm_bootstrap$Bootstrap_Button$button,
...
var _user$project$Workflows_SimpleTodos$iconForActionState = function (state) {
	var _p1 = state;
	if (_p1.ctor === 'Done') {
		return 'done';
	} else {
...
var _user$project$Main$getFromBin = function (uri) {
	return A2(_elm_lang$http$Http$get, uri, _user$project$ProgrissStore$decoder);
};
var _user$project$Main$putToBin = F2(
		...
		return _elm_lang$http$Http$request(
			{
				...
				headers: {ctor: '[]'},
				url: uri,
				body: _elm_lang$http$Http$jsonBody(jsonValue),
				expect: _elm_lang$http$Http$expectJson(_user$project$ProgrissStore$decoder),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
	});
var _user$project$Main$baseBinUri = 'https://api.myjson.com/bins';
var _user$project$Main$binUri = function (id) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$Main$baseBinUri,
...
var _user$project$Main$initialStore = function () {
	...
	var _p0 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$ProgrissStore$decoder, jsonData);
	if (_p0.ctor === 'Ok') {
		return _p0._0;
	} else {
...
var _user$project$Main$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {store: a, gtdActionListsModel: b, projectCardOverviewModel: c, simpleTodosModel: d, settingsModel: e, selectedWorkflow: f, workflowMenuVisible: g, pasteBinId: h};
	});
var _user$project$Main$PasteBinResult = function (a) {
	return {uri: a};
};
var _user$project$Main$pasteBinResultDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'uri',
	_elm_lang$core$Json_Decode$string,
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$PasteBinResult));
var _user$project$Main$postToBin = function (jsonValue) {
	return A3(
		_elm_lang$http$Http$post,
		_user$project$Main$baseBinUri,
		_elm_lang$http$Http$jsonBody(jsonValue),
		_user$project$Main$pasteBinResultDecoder);
};
...
var _user$project$Main$RecieveBinConfirmation = function (a) {
	return {ctor: 'RecieveBinConfirmation', _0: a};
};
var _user$project$Main$ToggleDrawer = function (a) {
	return {ctor: 'ToggleDrawer', _0: a};
};
var _user$project$Main$TriggerBinLoad = function (a) {
	return {ctor: 'TriggerBinLoad', _0: a};
};
var _user$project$Main$TriggerStoreLoad = {ctor: 'TriggerStoreLoad'};
var _user$project$Main$ReceiveStoreFromBin = function (a) {
	return {ctor: 'ReceiveStoreFromBin', _0: a};
};
var _user$project$Main$initialModel = function (location) {
	var search = _elm_lang$core$List$head(
		_elm_lang$core$List$reverse(
			A2(_elm_lang$core$String$split, '#', location.hash)));
	return {
		ctor: '_Tuple2',
		_0: {
			store: _user$project$Main$initialStore,
			gtdActionListsModel: _user$project$Workflows_GtdActionLists$initialModel,
			projectCardOverviewModel: _user$project$Workflows_ProjectOverview$initialModel,
			simpleTodosModel: _user$project$Workflows_SimpleTodos$initialModel,
			settingsModel: _user$project$Workflows_Settings$initialModel,
			selectedWorkflow: _user$project$Main$GtdActionListsWorkflow,
			workflowMenuVisible: false,
			pasteBinId: _elm_lang$core$String$isEmpty(
				A2(_elm_lang$core$Maybe$withDefault, '', search)) ? _elm_lang$core$Maybe$Nothing : search
		},
		_1: function () {
			var _p1 = search;
			if (_p1.ctor === 'Nothing') {
				...
				if (_p2 === '') {
					...
					return A2(
						...
						_user$project$Main$ReceiveStoreFromBin,
						_user$project$Main$getFromBin(
							_user$project$Main$binUri(_p3)));
				}
			}
		}()
	};
...
var _user$project$Main$ProjectOverviewMsg = function (a) {
	return {ctor: 'ProjectOverviewMsg', _0: a};
};
var _user$project$Main$GtdActionListsMsg = function (a) {
	return {ctor: 'GtdActionListsMsg', _0: a};
};
	...
	function (msg, model) {
		...
		switch (_p4.ctor) {
			...
			case 'Save':
				return {
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: _user$project$Main$persistStore(
								A2(
							...
							_1: {
								ctor: '::',
								_0: function () {
									var _p5 = model.pasteBinId;
									if (_p5.ctor === 'Nothing') {
										return A2(
											_elm_lang$http$Http$send,
											_user$project$Main$RecieveBinConfirmation,
											_user$project$Main$postToBin(
												_user$project$ProgrissStore$encoder(model.store)));
									} else {
										return A2(
											_elm_lang$http$Http$send,
											_user$project$Main$ReceiveStoreFromBin,
											A2(
												_user$project$Main$putToBin,
												_user$project$Main$binUri(_p5._0),
												_user$project$ProgrissStore$encoder(model.store)));
									}
								}(),
								_1: {ctor: '[]'}
			...
			case 'TriggerBinLoad':
				return {
					...
					_1: A2(
						...
						_user$project$Main$ReceiveStoreFromBin,
						_user$project$Main$getFromBin(
							_user$project$Main$binUri(_p4._0)))
				};
			case 'ReceiveStore':
				var _p6 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$ProgrissStore$decoder, _p4._0);
				if (_p6.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{store: _user$project$ProgrissStore$empty}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			...
			case 'GtdActionListsMsg':
				var _p8 = A3(_user$project$Workflows_GtdActionLists$update, _p4._0, model.store, model.gtdActionListsModel);
				var gtdActionListsModel = _p8._0;
				var store = _p8._1;
				var cmd = _p8._2;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{store: store, gtdActionListsModel: gtdActionListsModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$GtdActionListsMsg, cmd)
				};
			case 'ProjectOverviewMsg':
				var _p9 = A3(_user$project$Workflows_ProjectOverview$update, _p4._0, model.store, model.projectCardOverviewModel);
				var projectCardOverviewModel = _p9._0;
				var store = _p9._1;
				var cmd = _p9._2;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{store: store, projectCardOverviewModel: projectCardOverviewModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$ProjectOverviewMsg, cmd)
				};
			case 'SimpleTodosMsg':
				var _p10 = A3(_user$project$Workflows_SimpleTodos$update, _p4._0, model.store, model.simpleTodosModel);
				var simpleTodosModel = _p10._0;
				var store = _p10._1;
				var cmd = _p10._2;
				return {
					ctor: '_Tuple2',
			...
			case 'SettingsMsg':
				var _p11 = A3(_user$project$Workflows_Settings$update, _p4._0, model.store, model.settingsModel);
				var settingsModel = _p11._0;
				var store = _p11._1;
				var cmd = _p11._2;
				return {
					ctor: '_Tuple2',
			...
			case 'SelectWorkflow':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{selectedWorkflow: _p4._0, workflowMenuVisible: false}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ToggleDrawer':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{workflowMenuVisible: _p4._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				var _p12 = _p4._0;
				if (_p12.ctor === 'Ok') {
					var pasteBinId = _elm_lang$core$List$head(
						_elm_lang$core$List$reverse(
							A2(_elm_lang$core$String$split, '/', _p12._0.uri)));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
						...
						_1: function () {
							...
							if (_p13.ctor === 'Nothing') {
								...
								return _elm_lang$navigation$Navigation$modifyUrl(
									A2(_elm_lang$core$Basics_ops['++'], 'https://a5308y.github.io/Methodoly#', _p13._0));
							}
						}()
					};
				} else {
...
var _user$project$Main$workflowMenu = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'bmd-drawer-f-l', _1: true},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'bmd-drawer-overlay', _1: true},
							_1: {
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('bmd-layout-header'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_1: {
								ctor: '::',
								_0: function () {
									var _p14 = model.selectedWorkflow;
									if (_p14.ctor === 'GtdActionListsWorkflow') {
										return A2(
											_elm_lang$html$Html$map,
											_user$project$Main$GtdActionListsMsg,
											A2(_user$project$Workflows_GtdActionLists$navbarContent, model.store, model.gtdActionListsModel));
									} else {
								...
								},
								{
											...
											_1: {
												...
												_1: {
													...
													_0: A3(
														...
														_elm_lang$core$Json_Decode$succeed(
															_user$project$Main$SelectWorkflow(_user$project$Main$SimpleTodosWorkflow))),
													_1: {ctor: '[]'}
												}
											}
										},
									...
									_1: {
										...
										_0: A2(
												...
												_1: {
													...
													_1: {
														...
														_0: A3(
															...
															{stopPropagation: true, preventDefault: true},
															_elm_lang$core$Json_Decode$succeed(
																_user$project$Main$SelectWorkflow(_user$project$Main$GtdActionListsWorkflow))),
														_1: {ctor: '[]'}
													}
												}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('GTD'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
													...
													_1: {
														...
														_1: {
															...
															_0: A3(
																...
																{stopPropagation: true, preventDefault: true},
																_elm_lang$core$Json_Decode$succeed(
																	_user$project$Main$SelectWorkflow(_user$project$Main$ProjectOverviewWorkflow))),
															_1: {ctor: '[]'}
														}
													}
												},
																...
																_1: {
																	...
																	_1: {
																		...
																		_0: A3(
																			...
																			'click',
																			{stopPropagation: true, preventDefault: true},
																			_elm_lang$core$Json_Decode$succeed(_user$project$Main$Save)),
																		_1: {ctor: '[]'}
																	}
																}
															},
																	...
																	_1: {
																		...
																		_1: {
																			...
																			_0: A3(
																				...
																				'click',
																				{stopPropagation: true, preventDefault: true},
																				_elm_lang$core$Json_Decode$succeed(_user$project$Main$TriggerStoreLoad)),
																			_1: {ctor: '[]'}
																		}
																	}
																},
																...
																_0: function () {
																	...
																	if (_p15.ctor === 'Nothing') {
																		...
																		return A2(
																				...
																				_1: {
																					...
																					_1: {
																						...
																						_0: A3(
																							...
																							{stopPropagation: true, preventDefault: true},
																							_elm_lang$core$Json_Decode$succeed(
																								_user$project$Main$TriggerBinLoad(
																									_user$project$Main$binUri(_p15._0)))),
																						_1: {ctor: '[]'}
																					}
																				}
																			},
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text('Load from server'),
																				_1: {ctor: '[]'}
																			});
																	}
																}(),
...
var _user$project$Main$renderWorkflow = function (model) {
	var _p16 = model.selectedWorkflow;
	switch (_p16.ctor) {
		...
		case 'GtdActionListsWorkflow':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Main$GtdActionListsMsg,
				A2(_user$project$Workflows_GtdActionLists$view, model.store, model.gtdActionListsModel));
		default:
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Main$ProjectOverviewMsg,
				A2(_user$project$Workflows_ProjectOverview$view, model.store, model.projectCardOverviewModel));
	}
};
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$workflowMenu(model),
			_1: {
				ctor: '::',
				_0: _user$project$Main$renderWorkflow(model),
				_1: {ctor: '[]'}
			}
		});
};
